<template>
  <section class="our-form">
    ...
    <div class="form-group m-1 container">
      <h5>Choose test settings</h5>
      <div class="row justify-content-center">
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
          <div class="justify-content-start text-left">
            <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option0" @change="selectMode('oneGear')" />
    ...
    <div class="form-group m-1" v-if="myForm_0_isShown">
      <h5>Select Gearing Options For Single Gear</h5>
      <div class="row">
        <label class="col col-sm-6" for="">Initial speed km/h:</label>
        <input v-model="csin" @change="initialSpeedInputChange" type="number" class="form-control form-control-sm col col-sm-6" />
      </div>
      <div class="row">
    ...
    <div class="form-group m-1" v-show="formfixShow">
